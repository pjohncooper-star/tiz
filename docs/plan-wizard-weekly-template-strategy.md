...
**Status:** Layout strategy unchanged (option 2). **Production planner:** [season-planner-unified-plan.md](./season-planner-unified-plan.md). **Pool:** [calendar-workout-pool-v2.md](./calendar-workout-pool-v2.md).
