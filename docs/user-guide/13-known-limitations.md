...
| `docs/season-planner-ui-refresh.md` | Chosen direction shipped: 3-step create wizard + timeline workbench + cross-phase load table. Historical options remain in the doc. The shipped planner is described in [chapter 5](./05-season-planner.md). |
