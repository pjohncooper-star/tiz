...
It documents behavior that is actually implemented. Where the app has a rough edge or a known gap, the guide says so rather than pretending otherwise; those notes are marked **Known limitation**.
