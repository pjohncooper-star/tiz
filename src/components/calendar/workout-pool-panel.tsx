...
export function WorkoutPoolPanel(props: WorkoutPoolPanelProps) {
  ...
  return (
    <>
      {/* Desktop / xl sticky column */}
      <div
        className={`hidden xl:block xl:w-60 xl:shrink-0 ${open ? "" : "xl:hidden"}`}
        aria-hidden={!open}
      >
        <div className="sticky top-[4.5rem] max-h-[calc(100vh-5.5rem)] space-y-2 overflow-y-auto pb-4">
