...
export const THRESHOLD_HISTORY_INTRO =
  "Zone calculations use the values, primary metric, and any session-role metric " +
  "overrides in effect on each activity date.";
...
/** Dated threshold and primary-metric entries, listed and editable. */
export function ThresholdHistoryEditor() {
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-zinc-500">{THRESHOLD_HISTORY_INTRO}</p>
