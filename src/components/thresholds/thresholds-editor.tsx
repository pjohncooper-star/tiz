...
/**
 * Current thresholds, primary metric and zone boundaries. Values autosave on
 * blur; the footer button flushes pace inputs and role overrides, which only
 * save on demand. The caller supplies the surrounding heading and decides where
 * (if anywhere) to go afterwards via `onSaved`.
 */
