...
export const simplePhaseSchema = z
  .object({
    ...
    volumeMesocycleMode: z.enum(["INCREASE", "HOLD", "DECREASE"]).nullable().optional(),
    volumeProgressionMode: z.enum(["TARGET", "PERCENT", "STEP"]).nullable().optional(),
    ...
    volumeStepHours: z.number().nonnegative().nullable().optional(),
    ...
    swimStepHours: z.number().nonnegative().nullable().optional(),
    ...
    bikeStepHours: z.number().nonnegative().nullable().optional(),
